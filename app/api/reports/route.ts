...
// GET /api/reports?type=producer_customer|value_add&from=YYYY-MM-DD&to=YYYY-MM-DD
// The CSV export types (harvest, processing, orders, receiving, appointments)
// went with the Power BI setup (Charlie, 2026-09-09).
