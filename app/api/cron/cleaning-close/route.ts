...
// Scheduled 5 AM close of the cleaning shift — see vercel.json.
//
// A shift the crew forgot to close would otherwise sit open forever, which is
// exactly how every shift before 2026-09-05 ended up. The cutoff is 5:00 AM
...
//
// Vercel cron is UTC-only, so vercel.json fires this at both 11:00 and 12:00
// UTC — 5 AM Mountain in summer lands on the first, 5 AM in winter on the
