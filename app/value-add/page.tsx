...
// ══════════════════════════════════════════════════════════════════════════════
function JobCard({ job, onUpdated }: { job: ValueAddJob; onUpdated: (j: ValueAddJob) => void }) {
      ...
      {editingWeights ? (
        ...
        >
          ...
          <div>
            ...
            <div style={{ color: job.weight_out_lbs ? C.cream : C.lightBrown, fontWeight: 600, fontSize: '0.88rem' }}>
        ...
        return (
          <div key={type}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
              {group.map(j => (
                <JobCard key={j.id} job={j} onUpdated={handleUpdated} />
              ))}
            </div>
          </div>
        )
